...
return [
    ...
    'providers' => [
        ...
        'linkedin_page' => ['label' => 'LinkedIn Company Page', 'client_id' => env('LINKEDIN_PAGE_CLIENT_ID'), 'client_secret' => env('LINKEDIN_PAGE_CLIENT_SECRET'), 'approved' => env('LINKEDIN_PAGES_APPROVED', false)],
    ],
